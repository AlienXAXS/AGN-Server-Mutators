class AGN_Vehicle_StealthTank extends RX_Vehicle_StealthTank notplaceable;
...
simulated event PostBeginPlay()
{
	...
	Parent = MaterialInstanceConstant'RX_ENV_FORT.VehicleMaterials.MI_VH_StealthTank_New';

...
defaultproperties
{
    ...
    WeaponList(1)=class'Rx_Weapon_LaserRifle'
    WeaponList(2)=class'Rx_Weapon_TacticalRifle'
    WeaponList(3)=class'Rx_Weapon_Railgun'
    WeaponList(4)=class'AGN_Weapon_PersonalIonCannon'
    WeaponList(5)=class'Rx_Weapon_RocketLauncher'
    WeaponList(6)=class'Rx_Weapon_FlakCannon'
    WeaponList(7)=class'Rx_Weapon_Chaingun_Nod'
    WeaponList(8)=class'Rx_Weapon_ChemicalThrower'
    WeaponList(9)=class'Rx_Weapon_RepairGunAdvanced'
    WeaponList(10)=class'AGN_Weapon_Carbine_Silencer'
    WeaponList(11)=class'Rx_Weapon_LaserChainGun'

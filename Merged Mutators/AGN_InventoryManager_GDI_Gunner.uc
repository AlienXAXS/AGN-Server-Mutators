...
class AGN_InventoryManager_GDI_Gunner extends AGN_InventoryManager_Adv_GDI;

DefaultProperties
{
    PrimaryWeapons(0)=class'Rx_Weapon_RocketLauncher'
    PrimaryWeapons(1)=none
    PrimaryWeapons(2)=class'Rx_Weapon_ATMine'
    SidearmWeapons(0)=class'Rx_Weapon_Carbine'

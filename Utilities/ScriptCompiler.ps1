...
[string]$RenXUDKDirectory = "Z:\Games\RenegadeX\SDK"
...
$process = Start-Process $UDKBinary -ArgumentList "make -stripsource -unattended" -PassThru -Wait -WorkingDirectory $RenXUDKDirectory
